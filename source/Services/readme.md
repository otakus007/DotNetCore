...
public abstract record HttpService : IHttpService
{
    ...
    public async Task<Result> PostAsync(string uri, object request) { }

    public async Task<Result<T>> PostAsync<T>(string uri, object request) { }

    public async Task<Result> PutAsync(string uri, object request) { }
}
```
